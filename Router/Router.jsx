  ...
  recursive: (config = []) => {
    ...
    config.forEach((item) => {
      const route = {
        ...
        async: typeof item.async === 'boolean' ? item.async : Router.isAsync,
      ...
      if (Array.isArray(item.children)) {
        route.childRoutes = Router.recursive(item.children);
      }
      routeMap.push(route);
    });
    return routeMap;
            ...
            render={(props) => {
              ...
              return React.createElement(
                ...
                React.createElement((routeItem.async === true && routeItem.component !== undefined)
                  ? Loadable({loader: routeItem.component, loading: Loading})
